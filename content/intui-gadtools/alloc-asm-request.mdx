...
[AsmRequestArgs](/docs/intui-gadtools/asm-request-args), [ChangeAsmReqAttrsA](/docs/intui-gadtools/change-asm-req-attrs), [FreeAsmRequest](/docs/intui-gadtools/free-asm-request)
...
```asm
; (13-May-1995) --- AllocAsmRequestA(taglist) (a0)
