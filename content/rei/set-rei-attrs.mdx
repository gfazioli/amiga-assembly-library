...
See [OpenREIA](/docs/rei/open-rei) for the tag list, and the file `assembly/asmintuition.h` for the parameters that can be used with this command.
...
[OpenREIA](/docs/rei/open-rei), [GetREIAttrsA](/docs/rei/get-rei-attrs)
...
```asm
; (17-Mar-1995) --- SetREIAttrsA(rei,name,TagList) (a0/a1/a2)
SETREITable
        dc.l    SET_ESR                 * Offset...
