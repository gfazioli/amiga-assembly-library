...
[CloseREI](/docs/rei/close-rei), [FindREI](/docs/rei/find-rei), [GetREIAttrsA](/docs/rei/get-rei-attrs), [SetREIAttrsA](/docs/rei/set-rei-attrs)
...
```asm
; (25-Jan-1995) --- rei = OpenREIA(rei, name, taglist) (a0/a1/a2)
TagReiTable
        dc.l    SRE_ESR                 * Offset...
