...
The complete assembly source code for the Libraries module (`libraries.asm`).
...
* AS_AslRequest()	- V40
* FindAIFFChunk()	- V34 -i-
* TestAIFFChunk()	- V34 -i- possibly the only one recoverable for V41
* NextIFFChunk()	- V34 -i-
* UnPackerILBMBODY()	- V36 -i- Unpacks up to 8 bitplanes (256!!) :)
...
* Rel.1.0 * Last save: Jul 29 09:10 1991 =JON=
_LVONextIFFChunk
	move.l	4(a0),d0
	lea	8(a0,d0.l),a0
	move.l	4(a0),d0
